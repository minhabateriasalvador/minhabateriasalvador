...
export const brandPages = {
  moura: {
    ...
    brandName: 'Moura',
    title: 'Bateria Moura em Salvador com Entrega e Instalação Grátis',
    description: 'Bateria Moura em Salvador para carros, motos e veículos Start-Stop. Até 24 meses de garantia oficial de fábrica. Peça seu orçamento pelo WhatsApp.',
    heroTitle: 'Bateria Moura em Salvador com entrega e instalação grátis.',
  ...
  heliar: {
    ...
    brandName: 'Heliar',
    title: 'Bateria Heliar em Salvador com Tecnologia PowerFrame e 24 Meses de Garantia',
    description: 'Bateria Heliar em Salvador com a exclusiva tecnologia PowerFrame e proteção contra corrosão. Socorro 24h em todo o Brasil. Peça pelo WhatsApp.',
    heroTitle: 'Bateria Heliar em Salvador com tecnologia PowerFrame.',
  ...
  zetta: {
    ...
    brandName: 'Zetta',
    title: 'Bateria Zetta em Salvador | Fabricada pela Moura com Entrega Grátis',
    description: 'Bateria Zetta em Salvador: a qualidade e procedência do Grupo Moura com o melhor custo-benefício. Ideal para frotas e motoristas de aplicativo.',
    heroTitle: 'Bateria Zetta em Salvador: procedência Moura com economia.',
  ...
  startStop: {
    ...
    title: 'Bateria Start-Stop em Salvador (EFB e AGM) | Entrega e Instalação Técnica',
    description: 'Bateria Start-Stop EFB e AGM em Salvador com instalação técnica para preservar a memória eletrônica do seu veículo. Moura e Heliar pronta-entrega.',
    heroTitle: 'Baterias Start-Stop EFB e AGM em Salvador.',
