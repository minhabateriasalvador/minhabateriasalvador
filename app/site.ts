...
export const brandPages = {
  ...
  heliar: {
    ...
    brandName: 'Heliar',
    title: 'Bateria Heliar Salvador | Tecnologia PowerFrame e 24 Meses de Garantia',
  ...
  zetta: {
    ...
    brandName: 'Zetta',
    title: 'Bateria Zetta Salvador | Fabricada pela Moura com Entrega Grátis',
  ...
  startStop: {
    ...
    title: 'Bateria Start-Stop Salvador (EFB e AGM) | Instalação Técnica Grátis',
