...
export const metadata: Metadata = {
  ...
  openGraph: { ...social, title: 'Bateria em Salvador com entrega e instalação grátis', description: 'Moura, Zetta e Heliar. Peça sua bateria à Minha Bateria Salvador.', url: '/' },
};
...
export default function Home() {
  ...
  return <main id="conteudo">
    <section className="hero"><div className="container hero-grid"><div className="hero-copy">
      ...
      <h1>Bateria em Salvador<br />com entrega e<br /><span>instalação grátis.</span></h1>
      <p className="hero-description">Seu carro precisa de energia. Você precisa seguir.<br className="desktop-break" /> A Minha Bateria leva a bateria certa até você, com teste no local e garantia de fábrica.</p>
